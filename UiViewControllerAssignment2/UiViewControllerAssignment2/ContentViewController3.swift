...
class ContentViewController3: UIViewController {
    ...
    private func setupViews() {
        label = UILabel()
        label?.text = "Label in Content View 3"
        ...
        button = UIButton()
        button?.setTitle("Button in Content View 3", for: .normal)
